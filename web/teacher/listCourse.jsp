...
<div class="workingArea">
    <h1 class="label label-info" >课程查询</h1>
    <br>
    <br>
        ...
        <table class="table table-striped table-bordered table-hover  table-condensed">
            ...
            <c:forEach items="${thecs}" var="c">
                ...
                <tr>
                    ...
                    <%--<td><a href="teacher_course_edit?id=${c.id}"><span class="glyphicon glyphicon-edit"></span></a></td>--%>
                    <%--<td><a deleteLink="true" href="teacher_course_delete?id=${c.id}"><span class=" 	glyphicon glyphicon-trash"></span></a></td>--%>
    ...
    <%--<div class="panel panel-warning addDiv">--%>
        ...
        <%--<div class="panel-body">--%>
            <%--<form method="post" id="addForm" action="teacher_course_add" enctype="multipart/form-data">--%>
