...
<div class="workingArea">
        ...
        <table class="table table-striped table-bordered table-hover  table-condensed">
            ...
            <c:forEach items="${thecs}" var="c">
                ...
                <tr>
                    ...
                    <td><a href="admin_score_edit?id=${c.id}"><span class="glyphicon glyphicon-edit"></span></a></td>
                    <td><a deleteLink="true" href="admin_score_delete?id=${c.id}"><span class=" 	glyphicon glyphicon-trash"></span></a></td>
    ...
    <div class="panel panel-warning addDiv">
        ...
        <div class="panel-body">
            <form method="post" id="addForm" action="admin_score_add" enctype="multipart/form-data">
